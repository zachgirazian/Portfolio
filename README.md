...
| [Searching for Unusual Plasma in the Atmosphere of Mars ](https://github.com/zachgirazian/mars_solar_wind) | Programming, Visualization | Calculate paths to victory for the annual NFL Bracket Challenge with my friends | Python, Excel |
***
